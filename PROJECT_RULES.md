...
### Основные принципы
- **`www/tumski_cathedral_handler.js` остается универсальным** - работает для всех HTML файлов
...
### Структура файлов
```
www/locales/       # Файлы локализации (ru, en, de, pl, cs, be, uk)
www/styles.css     # Общие стили
www/tumski*.css    # Специфичные стили для страниц
www/tumski*.html   # HTML страницы
www/tumski*_init.js # Файлы инициализации для каждой страницы
www/tumski_cathedral_handler.js # Универсальный обработчик геометок
```
...
3. **НЕ изменять** `www/tumski_cathedral_handler.js`

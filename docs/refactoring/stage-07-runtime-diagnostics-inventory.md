...
| SPA shell diagnostics | `index.html` active SPA route/hash `console.log`, `audio.play().catch(console.log)` | Gate through small SPA debug helper or local debug methods; keep audio rejection handling behavior. | Stage 7.11 |

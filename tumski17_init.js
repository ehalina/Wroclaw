...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    Promise.all([
        ...
        const janNepomuk = document.getElementById('jan_nepomuk_quest');
        if (janNepomuk && questMod && typeof questMod.setupQuestGeoMarker === 'function') {
            questMod.setupQuestGeoMarker({
                markerId: 'jan_nepomuk_quest',
                questNumber: parseInt(janNepomuk.getAttribute('data-quest-number')),
                questImage: janNepomuk.getAttribute('data-quest-image')
            });
            ...
            try {
                ...
                const janNepomukMarker = document.getElementById('jan_nepomuk_quest');
                if (janNepomukMarker) {
                    janNepomukMarker.classList.add('quest-marker-glow');
                }
            } catch (e) {
                // no-op
            }

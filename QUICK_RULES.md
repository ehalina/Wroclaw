...
### 🏗️ Архитектура
- **`www/tumski_cathedral_handler.js` остается универсальным** - НЕ изменять!
...
- **Удалять**: HTML + инициализация (НЕ трогать `www/tumski_cathedral_handler.js`)
...
**Главное: `www/tumski_cathedral_handler.js` = универсальный, НЕ ТРОГАТЬ!**

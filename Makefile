...
help:
	...
	@printf "  make stage-06-25-loading-timeout Verify Stage 6.25 iframe loading timeout state\n"
...
stage-06-25-loading-timeout:
	E2E_PORT=$(E2E_PORT) npx playwright test --config=playwright.stage-06-25.config.mjs
